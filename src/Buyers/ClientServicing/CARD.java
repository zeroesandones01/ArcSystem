	...
	private void displayClientDetails(String entity_id, String proj_id, String pbl_id, int seq_no, Boolean toPrint) {
		...
		if(clientDetails != null){
			...
			try {
				...
				txtHLID.setText(FncGlobal.GetString("SELECT hlid_no from rf_hlid_no where entity_id = '"+entity_id+"' and proj_id = '"+proj_id+"' and pbl_id = '"+pbl_id+"' and seq_no = "+seq_no+" "));		} catch (Exception ex) {
