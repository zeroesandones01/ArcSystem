...
public class reversalProccessing extends _JInternalFrame implements _GUI, ActionListener {
	...
	private _JScrollPaneMain scrolldoc_reversed;
			...
			}
			{
				...
				pnlcenter.setBorder(JTBorderFactory.createTitleBorder("Details"));
				{
					...
					pnlcenter.add(tabCenter,BorderLayout.CENTER);
					{
						...
						tabCenter.addTab("Qualified for Reversal", scrolldoc_reversal);
					...
					{
						scrolldoc_reversed = new _JScrollPaneMain();
						tabCenter.addTab("Reversed JV", scrolldoc_reversed);
						scrolldoc_reversed.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
					}
				}
			}
			{
	...
	public void buttonstate( Boolean generate, Boolean save, Boolean refresh, Boolean cancel) {
		btngenerate.setEnabled(generate);
