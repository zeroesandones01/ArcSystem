...
public class FncGlobal {
	...
	*/
	...
	public static void CreateXLS(String strCol [], String strSQL, String strFile) {
		...
		/**		Set Directory													**/
		String strDir = OpenDir("Folder");

		/**		Check if file of the same name exists within the directory		**/
		Integer intSeq = 1;
		strFileNo = Padme(intSeq.toString(), 2);
	...
	public static void CreateXLSFromModel(String strCol [], String strHiddenCols [] ,DefaultTableModel model, String strFile){
		String strFileNo = "";
		String strFileName = "";
		String strDate = "";
